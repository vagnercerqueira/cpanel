...
function trocar_senha() {
	...
	$("body").append('<div class="modal altera_senha-modal-sm fade" data-backdrop="static">' +
		...
		'<p><input type="password" pattern="^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=\S+$).{6,}$" title="A senha deve conter entre 8 e 16 caracteres maiúsculos, minúsculos, números e caracteres especiais" class="form-control center" id="senha_nova" name="senha_nova" required maxlength="255" placeholder="Senha Nova"/></p>' +
