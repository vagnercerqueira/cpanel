    ...
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <form action="<?php echo base_url('/login'); ?>" method="post">
          ...
          <div class="input-group mb-3">
            <input type="password" name="senha" title="A senha deve conter entre 8 e 16 caracteres maiúsculos, minúsculos, números e caracteres especiais" autocomplete="off" maxlength="20" value="<?php echo $senha; ?>" class="form-control" required placeholder="Senha">
            <div class="input-group-append">
              <div class="input-group-text">
