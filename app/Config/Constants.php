...
defined('NOME_SISTEMA')      || define('NOME_SISTEMA', ''); //criar uma imagem com o mesmo nome do projeto para ser o logo
...
defined('BARRA_NAVEGACAO')      || define('BARRA_NAVEGACAO', 'L'); //T = TOP, L=LEFT